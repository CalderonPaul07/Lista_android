  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Persona` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `nombre` TEXT NOT NULL, `apellido` TEXT, `telefono` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e7fc9a2e9ec9b3fa08f8d31f4b94d3ea')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsPersona = new HashMap<String, TableInfo.Column>(4);
        ...
        _columnsPersona.put("telefono", new TableInfo.Column("telefono", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoPersona.equals(_existingPersona)) {
          return new RoomOpenHelper.ValidationResult(false, "Persona(ec.edu.tecnologicoloja.lista.dataBase.Persona).\n"
                  + " Expected:\n" + _infoPersona + "\n"
                  + " Found:\n" + _existingPersona);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "e7fc9a2e9ec9b3fa08f8d31f4b94d3ea", "e6b0af2ba2d4d3bc561d56eb4783709a");
